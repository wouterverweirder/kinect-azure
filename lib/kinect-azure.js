...
class KinectAzure {
 ...
 //K4A_COLOR_CONTROL_EXPOSURE_TIME_ABSOLUTE 
  ...
  setExposure(exposure) { return kinect.setExposure(exposure) }
  
  //Value of 0 means framerate priority. Value of 1 means exposure priority.
  setAutoExposurePriority(mode) { return kinect.setAutoExposurePriority(mode) }
  
  // The valid range is 0 to 255. The default value is 128.
  setBrightness(value) { return kinect.setBrightness(value) }

  // The valid range ?
  setContrast(value) { return kinect.setContrast(value) }

  // The valid range ?
  setSaturation(value) { return kinect.setSaturation(value) }

  // The valid range ?
  setSharpness(value) { return kinect.setSharpness(value) }

  // The unit is degrees Kelvin. The setting must be set to a value evenly divisible by 10 degrees.
  setWhiteBalance(value) { return kinect.setWhiteBalance(value) }

  // Value of 0 means backlight compensation is disabled. Value of 1 means backlight compensation is enabled.
  setBacklightCompensation(value) { return kinect.setBacklightCompensation(value) }

  // The valid range ?
  setGain(value) { return kinect.setGain(value) }

  // Value of 1 sets the powerline compensation to 50 Hz. Value of 2 sets the powerline compensation to 60 Hz.
  setPowerlineFrequency(value) { return kinect.setPowerlineFrequency(value) }
