...
class KinectAzure {
   ...
   * @param {number} options.include_depth_to_color generate depth to color image
   * @param {number} options.include_color_to_depth generate color to depth image
   * @param {number} options.flip_BGRA_to_RGBA flip blue and red channels
   */
