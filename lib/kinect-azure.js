...
class KinectAzure {
   ...
   * @param {number} options.processing_mode (KinectAzure.K4ABT_TRACKER_PROCESSING_MODE_GPU, KinectAzure.K4ABT_TRACKER_PROCESSING_MODE_CPU, KinectAzure.K4ABT_TRACKER_PROCESSING_MODE_GPU_CUDA, KinectAzure.K4ABT_TRACKER_PROCESSING_MODE_GPU_TENSORRT or KinectAzure.K4ABT_TRACKER_PROCESSING_MODE_GPU_DIRECTML)
   * @param {number} options.gpu_device_id The id of the GPU to use
   * @param {string} options.model_path Specify the model file name and location used by the tracker.
   */
...
{
  KinectAzure.K4ABT_TRACKER_PROCESSING_MODE_GPU = 0; /**< SDK will use the most appropriate GPU mode for the operating system to run the tracker */
